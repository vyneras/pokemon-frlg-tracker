...
DUNGEON_ENTRANCE_ITEMS = {
    ["Viridian Forest South Gate Exit (North)"] = VIRIDIAN_FOREST_SOUTH,
    ["Viridian Forest North Gate Exit (South)"] = VIRIDIAN_FOREST_NORTH,
    ["Mt. Moon (West)"] = MT_MOON_WEST,
    ["Mt. Moon (East)"] = MT_MOON_EAST,
    ["Vermilion Harbor"] = SS_ANNE,
    ["Diglett's Cave North Entrance"] = DIGLETTS_CAVE_NORTH,
    ["Diglett's Cave South Entrance"] = DIGLETTS_CAVE_SOUTH,
    ["Rock Tunnel (North)"] = ROCK_TUNNEL_NORTH,
    ["Rock Tunnel (South)"] = ROCK_TUNNEL_SOUTH,
    ["Power Plant (Front)"] = POWER_PLANT_FRONT,
    ["Power Plant (Back)"] = POWER_PLANT_BACK,
    ["Pokemon Tower"] = POKEMON_TOWER,
    ["Rocket Hideout"] = ROCKET_HIDEOUT,
    ["Safari Zone Entrance"] = SAFARI_ZONE,
    ["Silph Co."] = SILPH_CO,
    ["Seafoam Islands (South)"] = SEAFOAM_ISLANDS_SOUTH,
    ["Seafoam Islands (North)"] = SEAFOAM_ISLANDS_NORTH,
    ["Pokemon Mansion"] = POKEMON_MANSION,
    ["Victory Road (West)"] = VICTORY_ROAD_WEST,
    ["Victory Road (East)"] = VICTORY_ROAD_EAST,
    ["Mt. Ember"] = MT_EMBER,
    ...
    ["Pattern Bush (West)"] = PATTERN_BUSH_WEST,
    ["Pattern Bush (East)"] = PATTERN_BUSH_EAST,
    ["Altering Cave"] = ALTERING_CAVE,
    ["Monean Chamber"] = MONEAN_CHAMBER,
    ["Liptoo Chamber"] = LIPTOO_CHAMBER,
    ["Weepth Chamber"] = WEEPTH_CHAMBER,
    ["Dilford Chamber"] = DILFORD_CHAMBER,
    ["Scufib Chamber"] = SCUFIB_CHAMBER,
    ["Rixy Chamber"] = RIXY_CHAMBER,
    ["Viapois Chamber"] = VIAPOIS_CHAMBER,
